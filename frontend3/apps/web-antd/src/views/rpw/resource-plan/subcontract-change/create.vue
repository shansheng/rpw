...
const detailColumns = [
  ...
  },
  {
    ...
    customRender: ({ index }: any) =>
      h(
        Button,
        { type: 'link', onClick: () => openDateType(index) },
        () => dateTypeLabel(details.value[index]?.dateType),
      ),
  },
  {
    title: '原日期',
  ...
  },
  {
    ...
    customRender: ({ index }: any) =>
      h(DatePicker, {
        value: details.value[index]?.adjustedDate,
  ...
  },
  {
    ...
    customRender: ({ index }: any) =>
      h(
        Button,
        { type: 'link', danger: true, onClick: () => removeDetail(index) },
        () => '删除',
      ),
  },
];
