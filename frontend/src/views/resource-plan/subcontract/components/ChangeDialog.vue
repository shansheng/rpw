<template>
  ...
  >
    <el-form ref="formRef" :model="form" :rules="rules" label-width="120px">
      ...
      <el-form-item v-if="form.changeType === 'MODIFY'" label="新供应商编码">
        <el-input v-model="form.newSupplierCode" placeholder="请输入新供应商编码" />
      </el-form-item>

      <el-form-item v-if="form.changeType === 'MODIFY'" label="新供应商名称">
        <el-input v-model="form.newSupplierName" placeholder="请输入新供应商名称" />
      </el-form-item>
...
import { createChange } from '@/api/resourcePlanSubcontract'
import type { ResourcePlanSubcontract, ChangeDTO } from '@/api/resourcePlanSubcontract'

interface Props {
  visible: boolean
  data?: ResourcePlanSubcontract
}
